...
def _synthetic_bilateral_full_body_study() -> StudyData:
    ...
    left_femur = (z < 20) & (((x - 24) ** 2 + (y - 48) ** 2) <= 8**2)
    right_femur = (z < 20) & (((x - 72) ** 2 + (y - 48) ** 2) <= 8**2)

    left_tibia = (z >= 20) & (z < 62) & (((x - 22) ** 2 + (y - 46) ** 2) <= 6**2)
    left_fibula = (z >= 20) & (z < 62) & (((x - 31) ** 2 + (y - 46) ** 2) <= 4**2)
    right_tibia = (z >= 20) & (z < 62) & (((x - 65) ** 2 + (y - 46) ** 2) <= 6**2)
    right_fibula = (z >= 20) & (z < 62) & (((x - 74) ** 2 + (y - 46) ** 2) <= 4**2)
